    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 items-center md:gap-10 gap-6">
        <div className="max-md:order-1 max-md:text-center">
          ...
          <h2 className="text-gray-800 md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[55px]">Welcome to our healthcare </h2>
          <p className="mt-5 text-base text-gray-500 leading-relaxed">Embark on a gastronomic journey with our curated dishes, delivered promptly to your doorstep. Elevate your dining experience today.Embark on a gastronomic journey with our curated dishes, delivered promptly to your doorstep. Elevate your dining experience today.
        ...
        <div className="md:h-[400px] p-2 rounded-lg">
          <img src={lg} className="w-full h-full object-contain rounded-lg" alt="Experience" />
        </div>
      </div>
