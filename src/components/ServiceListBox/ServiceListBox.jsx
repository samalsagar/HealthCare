  ...
  Explore Our Top Healthcare Services
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={nurse} alt="Baby care icon" className="w-10 h-10" />
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={patholab} alt="Baby care icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
       ...
       <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={baby} alt="Baby care icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
                Baby Care Service
     ...
     <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={therapy} alt="Physiotherapy icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
       ...
       <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={preg} alt="Pregnancy Care icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
       ...
       <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={attendant} alt="Home Attendant icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={care} alt="Critical Care icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={citizen} alt="Senior Citizen Service icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer hover:bg-blue-50 hover:translate-y-2">
          <div className="flex items-center space-x-4">
            <div className="text-blue-500 text-4xl transition-all transform hover:scale-110">
              <img src={doctor} alt="Doctor Consultation icon" className="w-10 h-10" />
            </div>
            <div className="flex-grow">
              <h2 className="text-lg font-bold text-gray-800 mb-2 transition-all duration-300 hover:text-blue-600">
